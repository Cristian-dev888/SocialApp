...
class EventListScreen extends React.Component {
    ...
    static getDerivedStateFromProps(nextProps, state){
        return {
            openInviteDialog: nextProps.openedInvitePopup
        }
    }
    ...
    closeInviteDialog = () => {
        this.props.openInviteDialog(false);
    }
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <InviteDialog open={this.state.openInviteDialog} closeDialog={this.closeInviteDialog}/>
            </View>
        );
    }
}
